...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        String[][] subLocations = {
                // 0: 서울특별시 중구 (신당동 등)
                {"서울특별시 중구 신당동", "서울특별시 중구 약수동", "서울특별시 중구 황학동", "서울특별시 중구 명동", "서울특별시 중구 중림동", "서울특별시 중구 회현동"},
                // 1: 경기도 의정부시 (가능동 등)
                {"경기도 의정부시 가능동", "경기도 의정부시 호원동", "경기도 의정부시 신곡동", "경기도 의정부시 송산동", "경기도 의정부시 의정부동"},
                // 2: 서울특별시 용산구
                {"서울특별시 용산구 보광동", "서울특별시 용산구 한남동", "서울특별시 용산구 이태원동", "서울특별시 용산구 이촌동", "서울특별시 용산구 서빙고동"},
                // 3: 서울특별시 강남구
                {"서울특별시 강남구 역삼동", "서울특별시 강남구 개포동", "서울특별시 강남구 청담동", "서울특별시 강남구 삼성동", "서울특별시 강남구 대치동", "서울특별시 강남구 논현동"},
                // 4: 서울특별시 마포구
                {"서울특별시 마포구 서교동", "서울특별시 마포구 망원동", "서울특별시 마포구 합정동", "서울특별시 마포구 상암동", "서울특별시 마포구 아현동", "서울특별시 마포구 공덕동"},
                // 5: 서울특별시 종로구
                {"서울특별시 종로구 효자동", "서울특별시 종로구 사직동", "서울특별시 종로구 삼청동", "서울특별시 종로구 혜화동", "서울특별시 종로구 평창동"},
                // 6: 인천광역시 연수구
                {"인천광역시 연수구 송도동", "인천광역시 연수구 동춘동", "인천광역시 연수구 옥련동", "인천광역시 연수구 연수동", "인천광역시 연수구 선학동"},
                // 7: 경상남도 양산시
                {"경상남도 양산시 물금읍", "경상남도 양산시 동면", "경상남도 양산시 삼성동", "경상남도 양산시 중앙동", "경상남도 양산시 강서동"},
                // 8: 경기도 화성시
                {"경기도 화성시 봉담읍", "경기도 화성시 향남읍", "경기도 화성시 동탄동", "경기도 화성시 남양읍", "경기도 화성시 우정읍"},
                // 9: 충청남도 아산시
                {"충청남도 아산시 배방읍", "충청남도 아산시 신창면", "충청남도 아산시 탕정면", "충청남도 아산시 온양동"},
                // 10: 서울특별시 서초구
                {"서울특별시 서초구 서초동", "서울특별시 서초구 반포동", "서울특별시 서초구 방배동", "서울특별시 서초구 양재동", "서울특별시 서초구 잠원동"},
                // 11: 경기도 양주시
                {"경기도 양주시 옥정동", "경기도 양주시 삼숭동", "경기도 양주시 고읍동", "경기도 양주시 덕계동", "경기도 양주시 광적면"},
                // 12: 서울특별시 관악구
                {"서울특별시 관악구 신림동", "서울특별시 관악구 봉천동", "서울특별시 관악구 남현동", "서울특별시 관악구 보라매동"}
        };
        ...
        while (i < totalItems) {
            ...
            // 13개의 상위 지역 및 산하 하위 동들에 고르게 분산
            int parentIdx = i % subLocations.length;
            int subIdx = (i / subLocations.length) % subLocations[parentIdx].length;
            String location = subLocations[parentIdx][subIdx];
